...
/**
 * GSON type adapter for the Component polymorphic hierarchy. Serializes each
 * component as {"type": "fully.qualified.ClassName", "properties": {...}} so
 * the concrete subclass can be reconstructed on load.
 */
