...
/**
 * Orthographic camera. Builds a projection matrix from a configurable world-
 * space viewport size and a zoom factor, and a view matrix from the camera
 * position. Keeps the inverse of both matrices in sync for screen-to-world
 * unprojection in MouseListener.
 */
public class Camera {
