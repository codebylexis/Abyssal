...
/**
 * ImGui panel that displays the game framebuffer texture at the largest
 * 16:9 size that fits the panel, centered. Contains Play/Stop buttons that
 * fire engine events to switch between editor and runtime scenes.
 */
