...
/**
 * Reusable ImGui widget helpers. Each method renders a two-column layout with
 * a label on the left and a control on the right, keeping the editor visually
 * consistent. Widgets write their result back through the return value or by
 * mutating the passed-in vector.
 */
public class AbyssImGui {
