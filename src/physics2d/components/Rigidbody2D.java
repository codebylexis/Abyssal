...
/**
 * Component wrapping a JBox2D body. Stores body definition parameters so
 * Physics2D can create the body on start. Each update, position and rotation
 * are read back from the live Box2D body to keep the Transform in sync.
 */
