...
/**
 * Thin wrapper around a JBox2D World. Translates engine GameObjects with
 * Rigidbody2D components into Box2D bodies and fixtures, steps the simulation
 * at a fixed 60 Hz timestep, and exposes raycasting for ground detection.
 */
