...
/**
 * Finite state machine that drives sprite animation. States are AnimationState
 * objects; transitions are (currentState, trigger) -> nextState entries stored
 * in a hash map. Call trigger(String) each frame to fire a transition; the
 * active state's current sprite is pushed to the SpriteRenderer automatically.
 */
public class StateMachine extends Component {
	...
	private class StateTrigger {
		...
		public boolean equals(Object o) {
			...
			return t2.trigger.equals(trigger) && t2.state.equals(state);
		}
	...
	public HashMap<StateTrigger, String> stateTransfers = new HashMap<StateTrigger, String>();
	private List<AnimationState> states = new ArrayList<AnimationState>();
